...
export class migration1616108470200 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE "users_games_games" ( \
        ...
        CONSTRAINT "PK_cd4067d574477fd5c7693bc7872" PRIMARY KEY ("usersId", "gamesId") \
      )',
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      'ALTER TABLE \
        "users_games_games" \
      ADD CONSTRAINT \
        "FK_e5263d029d8644de829aae5c35a" \
      FOREIGN KEY ("usersId") \
    ...
    await queryRunner.query(
      'ALTER TABLE \
        "users_games_games" \
      ADD CONSTRAINT \
        "FK_934b0d8f9d0084c97d3876ad32d" \
      FOREIGN KEY ("gamesId") \
      REFERENCES "games"("id") ON DELETE CASCADE ON UPDATE NO ACTION',
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'ALTER TABLE \
        "users_games_games" \
      DROP CONSTRAINT "FK_934b0d8f9d0084c97d3876ad32d"',
    );
    await queryRunner.query(
      'ALTER TABLE \
        "users_games_games" \
      DROP CONSTRAINT "FK_e5263d029d8644de829aae5c35a"',
    );
